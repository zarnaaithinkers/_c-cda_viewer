...
function(t, i) {
  ...
  , h = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], d = h.length, u = !1;
  return r
}),
function(t, i) {
...
function(t, i) {
  ...
  o._bindStartEvent = function(i, e) {
      ...
      t.navigator.pointerEnabled ? i[n]("pointerdown", this) : t.navigator.msPointerEnabled ? i[n]("MSPointerDown", this) : (i[n]("mousedown", this),
      i[n]("touchstart", this))
  }
  ,
...
function(t, i) {
  ...
  o._dragPointerMove = function(t, e) {
      ...
      return !this.isDragging && this.hasDragStarted(o) && this._dragStart(t, e),
      o
  }
  ,
...
function(t, i) {
  ...
  function s(t, i) {
      this.element = "string" == typeof t ? h.querySelector(t) : t,
  ...
  g.dragEnd = function(t, i) {
      this.isEnabled && (c && (this.element.style[c] = "",
      this.setLeftTop()),
